...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('habits', 'App\Http\Controllers\Habit\HabitController')->except(['show']);
    Route::post('/habits/{habit}/complete', 'App\Http\Controllers\Habit\HabitLogController@store')->name('habits.complete');
});
